 ...
 */
export default function getLanguage(lang: string): Language | null;
export default function getLanguage<T extends readonly string[] | []>(langs: T): { [P in keyof T]: Language | null };
